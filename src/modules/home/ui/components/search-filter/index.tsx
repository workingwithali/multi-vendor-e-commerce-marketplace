...
import { BreadcrumNavigation } from "./breadcrum-navigation";
...
export const  SearchFilter = () => {
    ...
    const activeSubcategoryData = activeCategoryData?.subcategories?.find((subcategory) => subcategory.slug === subcategoryParam);
    const activeSubcategoryName = activeSubcategoryData?.name || null;


    return (
        <div className="px-4 lg:px-12 py-8 flex flex-col gap-4 border-b border-foreground w-full"
